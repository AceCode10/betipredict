...
export const metadata: Metadata = {
  ...
  description: "Trade on sports outcomes with Zambian Kwacha. Bet on football matches, predict results, and win big on Africa's first prediction market platform powered by a Central Limit Order Book.",
  keywords: ["prediction market", "sports betting", "Zambia", "football", "Kwacha", "BetiPredict", "CLOB", "order book", "Premier League", "La Liga", "Champions League", "trade", "predict"],
